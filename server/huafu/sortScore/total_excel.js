...
const excelSort = async function(src,dst){
                ...
                if (rowNumber >= 4) {
                    ...
                    row.eachCell((cell, colNumber)=>{
                        ...
                        if (colNumber === 4) {
                            ...
                            Object.assign(tmpObj, { totalRank: value })
                        }
                    });
                    newList.push(tmpObj)
                }
    ...
    const to900 = { key: '701-900', '五山': 0, '知识城': 0 }
    const to1200 = { key: '901-1200', '五山': 0, '知识城': 0 }
    ...
    Object.assign(to900, { '七年级01班':0, '七年级02班':0, '七年级03班':0,'七年级04班':0, '七年级05班':0, '七年级06班':0,'七年级1班':0, '七年级2班':0, '七年级3班':0,'七年级4班':0, '七年级5班':0, '七年级6班':0,'七年级7班':0, '七年级8班':0, '七年级9班':0, '七年级10班':0, '七年级11班':0, '七年级12班':0 })
    Object.assign(to1200, { '七年级01班':0, '七年级02班':0, '七年级03班':0,'七年级04班':0, '七年级05班':0, '七年级06班':0,'七年级1班':0, '七年级2班':0, '七年级3班':0,'七年级4班':0, '七年级5班':0, '七年级6班':0,'七年级7班':0, '七年级8班':0, '七年级9班':0, '七年级10班':0, '七年级11班':0, '七年级12班':0 })

    newList.forEach(el => {
        if (/^[0-9]*$/.test(el.totalRank)) {
            if (el.totalRank <= 10) {
            ...
            } else if (el.totalRank <= 900) {
                if (newClass.includes(el.className)) {
                    to900['知识城'] += 1;
                } else {
                    to900['五山'] += 1;
                }
                to900[el.className] += 1;
            } else {
                if (newClass.includes(el.className)) {
                    to1200['知识城'] += 1;
                } else {
                ...
                to1200[el.className] += 1;
            }
        }
    })

    const result = [to10, to50, to100, to200, to300, to400, to500, to600, to700, to900, to1200]
    ...
    fs.writeFile('data_total.json', JSON.stringify(result), (err) => {
        if (err) throw err;
